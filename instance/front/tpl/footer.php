...
<?php if (isset($_SESSION['user']['id']) and $_SESSION['user']['id'] != '') { ?>
    <script type="text/javascript"> 
    	...
    	$('<div id="copy_right" style="position:absolute;margin-left:58px;bottom:10px;">© 2013 Manage Contacts. All rights reserved </div>').appendTo('#main_content2'); 
        } else {
    	$('<div id="copy_right" style="float:left;margin-left:58px;margin-bottom:10px;">© 2013 Manage Contacts. All rights reserved </div>').appendTo('#main_content2');
        }  
